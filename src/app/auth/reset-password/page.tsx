      ...
      <div className="w-full max-w-sm">
        ...
        {step === 'loading' && (
          <div className="text-center space-y-3">
            ...
            <p className="font-jost text-nex-grey text-sm">Verificando el link…</p>
          </div>
        )}
        ...
        {step === 'success' && (
          <div className="bg-nex-dark border border-nex-green/30 rounded-2xl p-8 text-center space-y-4">
            ...
            <p className="font-jost font-bold text-nex-white text-lg">¡Contraseña actualizada!</p>
        ...
        {step === 'error' && (
          <div className="bg-nex-dark border border-white/10 rounded-2xl p-8 text-center space-y-4">
            <p className="font-jost font-bold text-nex-white text-lg mb-1">Link inválido o expirado</p>
            <p className="font-jost text-nex-grey text-sm">
              El link de restablecimiento expiró o ya fue usado. Pedí uno nuevo desde el login.
            </p>
            <Link
              href="/admin/login"
